...
# Prog Purpose: This program demonstrates how to manipulate a list, including:
    # finding number of itens in the list, sorting the list, adding/removing items,
    # copying a list of items into another list, and changing the data un the list.
...
def main():
    ...
    dogs.append("Ranger")
    print("\naAdd a dog to the end of a list, using appendd(): ")
    print(dogs)
    pause()
    ...
    print(dogs)
    print(another_dog + " was removed from position 3 in the list.")
    pause()
